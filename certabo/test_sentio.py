...
class TestSentio(unittest.TestCase):
    ...
    def test_capture_move(self, MockedParserCallback, MockedLedControl):
        ...
        calls = [call('rnbqkbnr/ppp1pppp/8/3p4/4P3/8/PPPP1PPP/RNBQKBNR'),
    ...
    def test_en_passant_move_a(self, MockedParserCallback, MockedLedControl):
        ...
        calls = [call('rnbqkbnr/pp2pppp/8/2pP4/8/8/PPPP1PPP/RNBQKBNR'),
    ...
    def test_castle(self, MockedParserCallback, MockedLedControl):
        ...
        sentio.occupied_squares(
            self._fen_to_occupied('rnbqk2r/pppp1ppp/5n2/2b1p3/2B1P3/5N2/PPPP1PPP/RNBQ2KR'))  # Kg1 down
        sentio.occupied_squares(
            self._fen_to_occupied('rnbqk2r/pppp1ppp/5n2/2b1p3/2B1P3/5N2/PPPP1PPP/RNBQ2K1'))  # Rh1 up
        sentio.occupied_squares(
            self._fen_to_occupied('rnbqk2r/pppp1ppp/5n2/2b1p3/2B1P3/5N2/PPPP1PPP/RNBQ1RK1'))  # Rf1 down
        calls = [call('rnbqk2r/pppp1ppp/5n2/2b1p3/2B1P3/5N2/PPPP1PPP/RNBQK2R'),
    ...
    def test_take_back_a(self, MockedParserCallback, MockedLedControl):
        ...
        calls = [call('rnbqkbnr/pppp1ppp/8/4p3/4P3/8/PPPP1PPP/RNBQKBNR'),
                 call('rnbqkbnr/pppppppp/8/8/4P3/8/PPPP1PPP/RNBQKBNR')]
        MockedParserCallback.board_update.assert_has_calls(calls)
    ...
    def test_take_back_b(self, MockedParserCallback, MockedLedControl):
        ...
        calls = [call('r2qkbnr/pp1npppp/3p4/2p5/4P3/5N2/PPPP1PPP/RNBQK2R'),
